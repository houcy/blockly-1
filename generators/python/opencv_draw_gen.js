...
Blockly.Python['draw_circle'] = function(block) {
    ...
    var value_radian = Blockly.Python.valueToCode(block, 'radian', Blockly.Python.ORDER_ATOMIC);
    var colour_color = block.getFieldValue('color');
    var number_thick = block.getFieldValue('thick');
    var rgb = hex2num(colour_color);
    var code = "cv2.circle("+value_image+", "+value_center+", "+value_radian+", ("+rgb+"), "+number_thick+" )\n";
    return code;
};
...
Blockly.Python['radian'] = function(block) {
