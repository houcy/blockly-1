...
// OpenCV Image Block
/** @type {string} */
/// OpenCV python code imread()
Blockly.Msg.CV_IMAGE_READ = 'Read image file  %1 %2 save it to %3 %4 attribute %5';
/** @type {string} */
/// OpenCV imread() option - without alpha
Blockly.Msg.CV_IMAGE_READ_WITHOUT_ALPHA = 'without alpha';
/** @type {string} */
/// OpenCV imread() option - as gray scale
Blockly.Msg.CV_IMAGE_READ_GRAYSCALE = 'as gray scale';
/** @type {string} */
/// OpenCV imread() option - unchanged
Blockly.Msg.CV_IMAGE_READ_UNCHANGED = 'unchanged';
/** @type {string} */
/// tooltip 
Blockly.Msg.CV_IMAGE_READ_TOOLTIP = 'Read a image from image file';
/** @type {string} */
/// {{Optional}} url - A link that OpenCV read image
Blockly.Msg.CV_IMAGE_READ_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code imshow()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV waitKey()
Blockly.Msg.CV_WAIT_KEY_NO_RET_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code waitKey() with return 
...
/** @type {string} */
/// OpenCV python code threshold()
Blockly.Msg.CV_IMAGE_THRESHOLD =  'Get threshold image from  %1 save it to  %2 %3 threshold  value %4 option %5';
/** @type {string} */
/// OpenCV threshold() option - 
Blockly.Msg.CV_IMAGE_THRESH_ATTR_BINARY = 'binary';
/** @type {string} */
/// OpenCV thershold() option - 
...
/** @type {string} */
/// tooltip 
Blockly.Msg.CV_IMAGE_THRESHOLD_TOOLTIP = 'Get theshold image from original image';
/** @type {string} */
/// {{Optional}} url - A link that OpenCV thershold() 
Blockly.Msg.CV_IMAGE_THERSH_ATTR_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code bitwiase and  
Blockly.Msg.CV_BIT_WISE_AND =  'Image bit AND operation   source 1: %1 source 2: %2 mask: %3';
/** @type {string} */
/// tooltip 
Blockly.Msg.CV_BIT_WISE_AND_TOOLTIP = 'Bit wise AND operation of 2 images';
/** @type {string} */
/// {{Optional}} url - A link that OpenCV bitwise and
Blockly.Msg.CV_BIT_WISE_AND_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code bitwiase not  
Blockly.Msg.CV_BIT_WISE_NOT =  'Image bit NOT operation    source: %1';
/** @type {string} */
/// tooltip 
Blockly.Msg.CV_BIT_WISE_NOT_TOOLTIP = 'Bit wise NOT operation of the image';
/** @type {string} */
/// {{Optional}} url - A link that OpenCV bitwise not
Blockly.Msg.CV_BIT_WISE_NOT_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code destroy all window
Blockly.Msg.CV_DESTROY_ALL_WINDOW =  'Destroy all window';
/** @type {string} */
/// tooltip 
Blockly.Msg.CV_DESTROY_ALL_WINDOW_TOOLTIP = 'Close image display window';
/** @type {string} */
/// {{Optional}} url - A link that OpenCV destroyAllWindow()
Blockly.Msg.CV_DESTROY_ALL_WINDOW_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code decode JPEG 
Blockly.Msg.DECODE_JPG =  'Decode JPEG image %1 save to  %2';
/** @type {string} */
/// tooltip 
Blockly.Msg.DECODE_JPEG_TOOLTIP = 'Decode bitmap image into JPEG image';
/** @type {string} */
/// {{Optional}} url - A link that decod_jpeg
Blockly.Msg.DECODE_JPEG_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code is_jpeg 
Blockly.Msg.IS_JPEG =  'Is byte array JPEG? %1 byte array: %2 result: %3';
/** @type {string} */
/// tooltip 
Blockly.Msg.IS_JPEG_TOOLTIP = 'Checking whether the image is JPEG or not';
/** @type {string} */
/// {{Optional}} url - A link that is_jpeg
Blockly.Msg.IS_JPEG_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code get_jpeg_img 
Blockly.Msg.GET_JPEG_IMAGE =  'Get JPEG image from %1 byte array: %2 save JPEG image to: %3 %4 result %5';
/** @type {string} */
/// tooltip 
Blockly.Msg.GET_JPEG_IMAGE_TOOLTIP = 'Get JPEG image from byte array';
/** @type {string} */
/// {{Optional}} url - A link that get_jpeg_img
Blockly.Msg.GET_JPEG_IMAGE_HELPURL = 'http://cobit.kr'
