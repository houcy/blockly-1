...
class Handler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path != "/":
            ...
            self.send_header("Location", "/little_car/index.html")
            self.end_headers()
...
if __name__ == '__main__':
    print "Blocklyduino can now be accessed at http://127.0.0.1:8081/"
    server = BaseHTTPServer.HTTPServer(("127.0.0.1", 8081), Handler)
    server.pages = {}
